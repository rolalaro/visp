...
*/
#ifndef VP_RB_BASE_ME_TRACKER_H
#define VP_RB_BASE_ME_TRACKER_H
...
*/
class VISP_EXPORT vpRBBaseMeTracker : public vpRBFeatureTracker
{
public:
  ...
  virtual ~vpRBBaseMeTracker() = default;
